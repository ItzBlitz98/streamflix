(function () {
    ...
    var movies = function () {
        ...
        var url = site_url + "/movies.php?page=" + count;
    ...
    var search = function (search) {
        ...
        var url = site_url + "/movies.php?page=1&genre=action&search=" + search;
    ...
    var fetchStreamlinks = function (number, data) {
        ...
        var url = site_url + "/movie.php?id=" + imdb;
    ...
    var startStream = function (data) {
        var options = [];
        spawn(player, [data].concat(options), { stdio: 'inherit' });
    };
